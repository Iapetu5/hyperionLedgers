          ...
          {LINKS.map((l) => {
            ...
            return (
              <Link
                ...
                className={
                  active
                    ? "font-semibold text-white underline decoration-brand-300 decoration-2 underline-offset-8"
                    : "hover:text-white hover:underline hover:decoration-white/50 hover:underline-offset-8"
                }
              >
                {l.label}
              </Link>

    ...
    return (
      <div className="space-y-4">
        {pageHeader(
          userRows.length === 0 ? (
            <>
              Make an invoice with an example (saved in this browser), or Try a demo for the full list. Past-due unpaid invoices show Overdue automatically (Draft stays Draft).
            </>
          ) : (
            <>
